...
const projects = [
  { icon: "fa-download", title: "Media Downloader", description: "Progressive Web App for downloading videos from YouTube, TikTok, Instagram, and Facebook with a clean interface and fast processing.", tags: ["Python", "Flask", "JavaScript", "Cobalt API"], github: "https://github.com/incognito-dev07/media-saver", live: "https://media-saver-hub.vercel.app" },
